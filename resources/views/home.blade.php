...
@section('content')
        ...
        <a class="button-81" href="/workcalendar/api/documentation" role="button" title="el contenido está en inglés">Documentación del API</a><a class="button-81" href="mailto:alguacilin@gmail.com" role="button">Contactar con el desarrollador</a>
@endsection
<!-- HTML !-->
