...
@section('content')
        ...
        <a class="button-81" href="/workcalendar/api/documentation" role="button" title="edukia ingelesez dago">APIaren dokumentazioa</a><a class="button-81" href="mailto:alguacilin@gmail.com" role="button">Garatzailearekin harremanetan jarri</a>
@endsection
<!-- HTML !-->
